      ...
      duration: 0.8
        ...
        duration: 0.8
          ...
          scale: 0.98
            ...
            <Button onClick={onStart} className="group bg-gold hover:bg-gold/90 text-starry px-10 py-7 rounded-xl text-lg font-medium shadow-gold-glow transition-all duration-300 border border-gold/30">
