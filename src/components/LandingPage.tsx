      ...
      duration: 0.8
        ...
        duration: 0.8
          ...
          <div className="relative mx-auto w-72 h-72 mb-6">
            ...
            <motion.div className="absolute inset-0 bg-gradient-to-br from-[#178582]/30 to-[#BFA181]/30 rounded-full blur-2xl opacity-70" animate={{
            scale: [1, 1.1, 1],
            opacity: [0.5, 0.7, 0.5]
          }} transition={{
            duration: 4,
            ...
            {/* Orbital ring with gold accents */}
            ...
            ease: "linear"
              ...
              {[...Array(12)].map((_, i) => <motion.div key={i} className="absolute w-2 h-2 bg-[#BFA181] rounded-full" animate={{
              opacity: [0.3, 1, 0.3]
            }} transition={{
              duration: 3,
              repeat: Infinity,
            ...
            repeatType: "reverse"
              ...
              <img src="/lovable-uploads/3d3b8ce7-1789-4fd0-ba94-16d161132e7e.png" alt="ImplantDX Logo" className="w-72 h-auto object-cover" />
            </motion.div>
          </div>

          <h2 className="text-3xl md:text-4xl gold-gradient-text font-light tracking-wider text-orange-400">
        ...
        duration: 0.8
          ...
          scale: 0.98
            ...
            <Button onClick={onStart} className="group text-starry px-10 py-7 rounded-xl text-lg font-medium shadow-gold-glow transition-all duration-300 border border-[#BFA181]/30 bg-orange-500 hover:bg-orange-400">
