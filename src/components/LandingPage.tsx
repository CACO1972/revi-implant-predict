      ...
      >
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
            <Button
              onClick={onStart}
              className="group text-starry px-10 py-7 rounded-xl text-lg font-medium shadow-gold-glow transition-all duration-300 border border-[#BFA181]/30 bg-[#BFA181] hover:bg-[#BFA181]/90"
            >
