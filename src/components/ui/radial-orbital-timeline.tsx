      ...
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-[#5BCBFF] via-[#178582] to-[#FF8C42] animate-pulse flex items-center justify-center z-10">
            <div className="absolute w-20 h-20 rounded-full border border-[#5BCBFF]/20 animate-ping opacity-70"></div>
            <div
              className="absolute w-24 h-24 rounded-full border border-[#178582]/10 animate-ping opacity-50"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div className="w-8 h-8 rounded-full bg-[#5BCBFF]/80 backdrop-blur-md flex items-center justify-center">
              <span className="text-[#040D18] font-bold text-xs">X</span>
            </div>
          </div>
