...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative overflow-hidden bg-gradient-to-br from-white to-gray-50">
      ...
      >
        {/* Logo animado - nuevo logo sin fondo */}
        <motion.div 
          className="mb-8" 
          animate={{ 
            y: [0, -15, 0],
        ...
        >
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <motion.div 
              className="bg-white/80 backdrop-blur-md border border-[#178582]/20 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300" 
              whileHover={{ scale: 1.02, boxShadow: "0 20px 40px rgba(23, 133, 130, 0.2)" }}
            >
              <div className="mb-4 flex justify-center">
                <motion.div 
                  ...
                  animate={{
                    ...
                    boxShadow: animatedElement === 0 ? [
                      "0 0 0 rgba(23, 133, 130, 0.4)", 
                      "0 0 15px rgba(23, 133, 130, 0.7)", 
                      "0 0 0 rgba(23, 133, 130, 0.4)"
                    ] : "0 0 0 rgba(23, 133, 130, 0.4)"
                  }}
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">Análisis potenciado por IA</h3>
            ...
            <motion.div 
              className="bg-white/80 backdrop-blur-md border border-[#BFA181]/20 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300" 
              whileHover={{ scale: 1.02, boxShadow: "0 20px 40px rgba(191, 161, 129, 0.2)" }}
            >
              <div className="mb-4 flex justify-center">
                <motion.div 
                  ...
                  animate={{
                    ...
                    boxShadow: animatedElement === 1 ? [
                      "0 0 0 rgba(191, 161, 129, 0.4)", 
                      "0 0 15px rgba(191, 161, 129, 0.7)", 
                      "0 0 0 rgba(191, 161, 129, 0.4)"
                    ] : "0 0 0 rgba(191, 161, 129, 0.4)"
                  }}
                  transition={{ duration: 1 }}
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">Resultados personalizados</h3>
              <p className="text-gray-600 text-sm">
            ...
            >
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">Evaluación en tiempo real</h3>
              <p className="text-gray-600 text-sm">
            ...
            >
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">100% confidencial</h3>
              <p className="text-gray-600 text-sm">
        ...
        >
          <div className="flex flex-col md:flex-row justify-center items-center gap-4">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
              <Button 
                ...
                className="bg-[#178582] hover:bg-[#178582]/90 text-white px-8 py-6 rounded-xl text-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-[#178582]/30 w-full md:w-auto"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
              <Button 
                ...
                variant="outline" 
                className="text-gray-700 border-gray-300 hover:bg-gray-50 px-8 py-6 rounded-xl text-lg transition-all duration-300 w-full md:w-auto group"
              >
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <motion.button 
                ...
                className="p-4 bg-white/80 backdrop-blur-md rounded-xl border border-gray-200 hover:border-[#178582]/30 hover:shadow-lg transition-all duration-300 flex flex-col items-center" 
                onClick={() => openModal("clinical-flow")}
              >
                <div className="text-gray-700 text-xs font-medium">Tú estás aquí</div>
              </motion.button>
              ...
              >
                <div className="text-gray-700 text-xs font-medium">Alternativas de Tratamiento</div>
              </motion.button>
              ...
              >
                <div className="text-gray-700 text-xs font-medium">Calculadora de Costos</div>
              </motion.button>
            </div>
          </div>
          ...
          <AnimatePresence>
            <motion.div 
              ...
              className="mt-12 max-w-3xl mx-auto bg-white/80 backdrop-blur-md rounded-xl p-6 border border-gray-200 shadow-lg"
            >
        ...
        >
          ...
          <div className="flex items-center justify-center mt-3 space-x-6">
            <motion.a 
              ...
              className="text-gray-400 hover:text-[#BFA181] transition-all"
            >
            ...
            <motion.a 
              ...
              rel="noopener noreferrer" 
              whileHover={{ scale: 1.1, rotate: -5 }} 
              className="text-gray-400 hover:text-[#178582] transition-all"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.917 3.917 0 0 0-1.417.923A3.927 3.927 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916 3.916 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.926 3.926 0 0 0-.923-1.417A3.911 3.911 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.47 2.47 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.478 2.478 0 0 1-.92-.598 2.48 2.48 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233 0-2.136.008-2.388.046-3.231.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334z" />
              </svg>
